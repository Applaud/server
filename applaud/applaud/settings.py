# Django settings for applaud project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'apatapaDB', #CWD+'/test.db',                      # Or path to database file if using sqlite3.
        'USER': 'apatapa',                      # Not used with sqlite3.
...
SECRET_KEY = 'adbiax8#$7wv4p4_6328&amp;gapp&amp;d1*0b7i#toe#*lc0*63ycsg9'
