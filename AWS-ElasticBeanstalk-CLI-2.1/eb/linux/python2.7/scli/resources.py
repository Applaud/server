...
class EBSCliAttr(object):
    ...
    Version = u'AWS Elastic Beanstalk Command Line Interface v2.1'
...
class DevToolsMessage(object):
    GitRepoNotExist = u'Warning: Your directory has not been initialized as a Git repository. '\
        'To create a local Git repository, run "git init" and then re-run the "eb {0}" command.'
    ...
    FileMissingError = u'Cannot locate the AWS Dev Tools initialization script.'    
