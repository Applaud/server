...
from lib.aws.exception import UnknownHttpCodeException
...
class ElasticBeanstalkClient(object):
    ...
    def create_environment(self, application, environment, cname_prefix = None, 
        ...
        if (template is None and solution_stack is None) \
            ...
            raise AttributeError('Must specify either solution stack or template.') 
    ...
    def update_environment(self, env_name = None, env_id = None, 
        ...
        if (env_name is None and env_id is None) :
            raise AttributeError(u'Must specify either environment name or environment id.') 
    ...
    def terminate_environment(self, environment_name, 
        ...
        if (environment_name is None and environment_id is None) :
            raise  AttributeError(u'Must specify either environment name or ID')
    ...
    def create_configuration_template(self, application, template, 
        ...
        if (environment_id is None and solution_stack is None and source_configuration is None) \
            or (environment_id is not None and source_configuration is not None):
            raise AttributeError(u'Template source combination is invalid.') 
