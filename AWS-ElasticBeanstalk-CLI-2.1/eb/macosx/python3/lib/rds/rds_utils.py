...
from lib.elasticbeanstalk.request import TemplateSource
...
#     Utility functions
#-----------------------------------
def rds_handler(parameter_pool, stack_name, option_settings, option_to_remove):
    ...
    if parameter_pool.get_value(ParameterName.RdsEnabled):
        return _add_rds_extension(parameter_pool, option_settings, option_to_remove)
    else:
        return _remove_rds_extension(parameter_pool, option_settings, option_to_remove)
